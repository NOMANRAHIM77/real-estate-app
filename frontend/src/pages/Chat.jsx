    ...
    <div className="h-full flex flex-col">
      ...
      {chat && (
        <div className="flex-1 bg-white flex flex-col justify-between rounded-t-xl shadow-lg mt-4 border border-gray-100">
            ...
            {chat.messages.map((message) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[10px] bg-[#f7c14b39] p-1 rounded self-start w-max">
          ...
          {/* BOTTOM (INPUT) */}
          <form onSubmit={handleSubmit} className="border-t-2 border-[#f7c14b85] h-16 flex items-center justify-between">
            <textarea 
              name="text" 
              className="flex-[3] h-full border-none p-5 outline-none resize-none"
              placeholder="Type a message..."
            ></textarea>
            <button className="flex-1 bg-[#f7c14b85] h-full border-none cursor-pointer font-bold hover:bg-[#f7c14bd1] transition-colors">
              Send
            </button>
          </form>
        </div>
